...
pip install -r requirements.txt 2>/dev/null || pip install fastapi uvicorn sqlalchemy pymysql cryptography alembic celery redis pytest requests pyyaml allure-pytest pydantic
